...
- **Modernes UI** - Dark Theme mit Glassmorphism, Gradienten und flüssigen Animationen
...
- **Multi-Hoster Support** - VOE, Streamtape, FileMoon, Vidoza und mehr
...
- **Settings** - Datenverwaltung, Stats und Info
...
- **DataStore Preferences** (Recent Searches)
...
├── data/
│   ├── api/          # NetworkModule, Scraper, API Interface
│   ├── db/           # Room Database, Entities, DAOs
│   ├── model/        # Data classes (Series, Episode, Season, etc.)
│   └── repository/   # Repositories (NovaStream, Watch)
├── ui/
│   ├── components/   # Shared Composables (Cards, BottomBar, etc.)
...
└── util/             # HosterResolver, VoeWebViewResolver
```
...
3. App öffnen und Serien streamen
...
NovaStream ist ein inoffizieller Client und nicht mit serienstream.to affiliated. Die App ist nur für Bildungszwecke. Verwende sie auf eigene Verantwortung.
